...
$produkt = $_GET["id"];
$statement = $pdo->prepare("SELECT * FROM produkte WHERE ArtikelID = $produkt");
...
<h2><b> <?php echo $bild['Bezeichnung'] ?> </b></h2>
  <p> <?php echo $bild['Beschreibung'] ?> </p>
</div>

<div>
  <div class="gradient">

  <p id="preis"><font size="5"><b><?php echo $bild['Preis'] ?>€</b></font></p>

<a href="inbuychart.php?id=<?php echo $produkt ?>" class="btn btn-default">In den Warenkorb</a>
